...
export default AuditType.extend({
  optionName: 'CMS',
  optionValue: 'cms',
  radioTitle: '2-7, 1 w/detail + complete',
  examElementOptions: null,
  organOptions: null,
  bodyOptions: null,

  isOneOrMoreOrganSystems: false,
  ...
  setCollections() {
    setProperties(this, {
      ...
      organOptions: [
        ...
        Object.create({ optionName: 'Musculoskeletal', optionValue: '' }),
        Object.create({ optionName: 'Skin', optionValue: 'skin' }),
        Object.create({ optionName: 'Neurologic', optionValue: 'neruologic' }),
