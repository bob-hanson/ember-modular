...
export default FacilityBaseRoute.extend({
  ...
  model() {
    return get(this, 'store')
      .query('facility-audit', { facility_project_id: this.modelFor('projects.outpatient.project').get('id') });
  },
  ...
  processTableOptions(table, options) {
    ...
    fd.append('project_id', this.modelFor('projects.outpatient.project').get('id'));
